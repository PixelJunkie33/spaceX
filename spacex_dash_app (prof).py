...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                            ...
                            html.Div(dcc.Graph(id='success-pie-chart', figure={
                                'data': [
                                    {'x': spacex_df['Launch Site'], 'y': spacex_df['class'], 'type': 'pie', 'name': 'SF'},
                                ],  
                                'layout': { 
                                ...
                                html.Div(dcc.Graph(id='success-payload-scatter-chart' , figure={
                                    'data': [   
                                        {'x': spacex_df['Payload Mass (kg)'], 'y': spacex_df['class'], 'type': 'scatter', 'name': 'SF'},
                                        ],
                                        'layout': {
...
def get_pie_chart(entered_site):
    ...
    if entered_site=='ALL':
        ...
        fig=px.pie(filtered_df[filtered_df['Launch Site']==entered_site],values='class',names='class',title=f"Success count for site {entered_site}")
        return fig
